    ...
    class TheCitizen2AndReturns : GameSupport
    {
        ...
        protected override void OnSessionStartInternal(GameState state, TimerActions actions)
        {
            if (IsFirstMap)
            {
                ...
                Logging.WriteLine("target trigger found at " + _trigIndex);
            }
        }
        ...
        protected override void OnUpdateInternal(GameState state, TimerActions actions)
        {
            ...
            if (this.IsFirstMap)
            {
                ...
                {
                    OnceFlag = true;
                    Logging.WriteLine("the citizen 2 start");
            ...
            else if (this.IsLastMap)
            {
                ...
                {
                    OnceFlag = true;
                    Logging.WriteLine("the citizen 2 end");
            ...
            else if (state.Map.Current == "sp_waterplant2")
            {
                ...
                {
                    OnceFlag = true;
                    Logging.WriteLine("the citizen returns end");
                    actions.End(); 
                }
            }
