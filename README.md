...
SourceSplit is a [LiveSplit](https://www.livesplit.org/) component which adds automated Start, Stop, and Splitting functionality for Source Engine games, along with other features geared towards speedrunning.  
